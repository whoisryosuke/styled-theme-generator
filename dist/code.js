            ...
            (_a = Object.keys(themeObject)) === null || _a === void 0 ? void 0 : _a.map((name) => {
                ...
                if (typeof themeColor === "object") {
                    ...
                    return colorKeys.forEach((objProperty) => {
                        ...
                        console.log("checking for nested obj", themeColor, objProperty, nestedKeys);
