...
figma.ui.onmessage = (msg) => {
    ...
    if (msg.type === "copy") {
        ...
        const fontFamiliesWithDupes = textStyles
            ...
            .sort();
        // Remove dupes
        const fontFamilies = fontFamiliesWithDupes.filter((item, index) => fontFamiliesWithDupes.indexOf(item) == index);
